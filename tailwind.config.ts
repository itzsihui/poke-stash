  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 20px var(--primary), 0 0 40px var(--primary)" },
          "50%": { boxShadow: "0 0 30px var(--primary), 0 0 60px var(--primary)" },
        },
        "border-glow": {
          "0%, 100%": { borderColor: "hsl(var(--primary))" },
          "50%": { borderColor: "hsl(var(--epic))" },
        },
        "fade-in": {
          "0%": { opacity: "0" },
          "100%": { opacity: "1" },
